...
import org.knowhowlab.configvalidator.api.annotations.StringRegexValidation;
 ...
 * @author dpishchukhin
 */
public class StringRegexValidator implements InternalConfigurationValidator<String, StringRegexValidation> {
    @Override
    ...
    @Override
    public void validate(String name, String object, StringRegexValidation annotation) throws InvalidConfigurationException {
